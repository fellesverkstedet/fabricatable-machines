...
G92 X165.99 Y-9 Z0 		;set the difference between homing location and where we want X and Y home postion to be
G0 X162 Y-6 Z0			;quickly jog to a good postion to start probing. X is important, Z negative is just to save some time
